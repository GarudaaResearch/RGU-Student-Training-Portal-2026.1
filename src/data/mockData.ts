...
export const MOCK_ANNOUNCEMENTS: Announcement[] = [
  ...
  { id: 'a2', title: '📅 Day 1 AI Basics Session — Tomorrow 9 AM', content: 'All Year 1 students are invited to attend the AI Basics Day session tomorrow. Join via the Sessions tab. Bring your laptop!', createdBy: 'f001', createdAt: '2026-06-02T08:00:00', targetRoles: ['student'], priority: 'medium' },
  { id: 'a3', title: '🏆 Hackathon Registration Open', content: 'Register for the June 8 AI Hackathon now. Teams of 2-4 students. Over ₹50,000 in prizes. Registration closes June 6.', createdBy: 'cii_admin1', createdAt: '2026-05-30T10:00:00', targetRoles: ['student'], priority: 'medium' },
